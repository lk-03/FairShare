...
export function EditExpenseModal({ visible, onClose, expenseToEdit }: EditExpenseModalProps) {
  ...
  const selectedCohortId = expenseToEdit.cohortId;
  ...
  const handleSave = () => {
    ...
    Alert.alert('Success', 'The users involved have been notified about this edit.');
    onClose();
  };
    ...
    <Modal visible={visible} animationType="slide" presentationStyle="fullScreen" onRequestClose={onClose}>
      <SafeAreaView className="flex-1 bg-slate-50">
        ...
        >
          ...
          <View className="card-main p-6 items-center justify-center bg-white shadow-sm rounded-3xl">
          ...
          {/* DESCRIPTION SECTION */}
          <View className="card-main p-5 gap-3 bg-white rounded-3xl">
          ...
          {/* CATEGORY SECTION */}
          <View className="card-main p-5 gap-3.5 bg-white rounded-3xl">
          ...
          <View className="card-main p-5 gap-4 bg-white rounded-3xl">
